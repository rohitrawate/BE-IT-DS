...
abstract public class CalculatorHelper
{
  ...
  public static CalculatorApp.Calculator narrow (Object ref)
  {
    if (ref == null)
      return null;
    else if (ref instanceof CalculatorApp.Calculator)
      return (CalculatorApp.Calculator)ref;
    else if (!((org.omg.CORBA.Object) ref)._is_a (id ()))
      throw new org.omg.CORBA.BAD_PARAM ();
    else
    {
      org.omg.CORBA.portable.Delegate delegate = ((org.omg.CORBA.portable.ObjectImpl)ref)._get_delegate ();
